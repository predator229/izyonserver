...
<li class="sub-menu">
  ...
  <ul class="active sub">
    <li class=""><a class="fa fa-user" href="{{ asset('user/profil') }}"> Profil</a></li>
    <li ><a class="fa fa-users" href="{{ asset('reglage/personnelplus') }}"> Personnel</a></li>
    @if (Auth()->User()->typeUtilisateur == 'AdminSysteme' || Auth()->User()->typeUtilisateur == 'Gerant')
    <li class="active"><a class="fa fa-gears" href="{{ asset('reglage/reglagebase') }}"> Reglage de base</a></li>
    @endif
  </ul>
</li>
  ...
  <section id="container">
    ...
    {{-- <div class="row"> --}}
        ...
        <div class="container">
            ...
            <div class="row container">
              ...
              @endif
                <div class="col-md-12 ">
                  <div class="row">
                    <div class="col-xs-10"><h3 class="text-center">Information generale de la boutique</h3></div>
                    <div class="col-xs-2 text-right"> <h3 ><button class="btn btn-danger" onclick="lafonct2()"><i class="fa fa-edit"></i></button></h3> </div>
                  </div>
                  <form action="{{ asset('reglage/updatee/info') }}" method="post" >
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control text-right" name="name" id="name" value="{{ App\Boutique::findOrFail(App\Annexe::findOrFail(Auth()->User()->idannexe)->idEtablissement)->nomEtablissement}} " readonly required>
                    </div>
                    <div class="form-group">
                        <label for="adresse">Votre adresse</label>
                        <input type="text" class="form-control text-right" id="adresse" value="{{ App\Boutique::findOrFail(App\Annexe::findOrFail(Auth()->User()->idannexe)->idEtablissement)->adresseEtablissement}}" name="adresse" readonly required>
                    </div>
                    <div class="form-group">
                        <label for="tel">Votre telephone</label>
                        <input type="text" class="form-control text-right" name="telephone" id="telephone" value="{{ App\Boutique::findOrFail(App\Annexe::findOrFail(Auth()->User()->idannexe)->idEtablissement)->telephoneEtablissement}}" name="telephone" readonly required>
                    </div>
        ...
        <div class="row">
          <hr>
          <div class="block">
            <h4>Gestion des annexes</h4>
            <p class="text-center infoo">Cette version ne comprend ps l gestion des annexes !</p>
          </div>
        </div>
