...
<head>
    <title>izyStock | Point total </title>
    <!-- Custom CSS -->
...
<body>
	<div class="container">
		...
		<div class="text-center col-12">
			...
			<div style="float: right; font-size: 15px;"> <b>Point total </b> </div><br>
        </div>
		<hr>
        <br>
		<?php 
        ...
        <div class="col-12">
			...
			<span style="float: right;"><b>Reccette de la totale du vendeur</b> : {{ $total }} FCFA </span>
        </div>
        <br>
