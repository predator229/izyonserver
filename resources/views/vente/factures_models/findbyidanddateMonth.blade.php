...
<head>
    <title>izyStock | Inventaire du {{$_GET['date']}} </title>
    <!-- Custom CSS -->
...
<body>
	<div class="container">
		...
		<div class="text-center col-12">
			...
			<div style="float: right; font-size: 15px;"> <b>Inventaire du {{ $_GET['date'] }} </b> </div><br>
        </div>
		<hr>
        <br>
        <?php 
        ...
        @foreach ($lesventes as $item)
            @if (  $item->created_at->format('Y-m') == $_GET['date'] )
        ...
        <div class="col-12">
			...
			<span style="float: right;"><b>Reccette du mois<0/b> : {{ $total }} FCFA </span>
        </div>
        <br>
        ...
        @php
            ...
            $toutesventes = App\Vente::where('idannexe', AUth()->User()->idannexe)->get();
                ...
                # code...
            $toutesventes = App\Vente::where('idemploye', $_GET['user'])->get();
